                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3 form-group">
                                                ...
                                                <input type="text" id="phone" name="phone"
                                                    ...
                                                    oninput="digitInput(this)" readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3 form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3 form-group">
                                                ...
                                                <input type="text" id="date_of_birth" name="date_of_birth"
                                                    ...
                                                    value="{{ $student->user_details->date_of_birth ?? '' }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3 form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3 form-group">
                                                ...
                                                <select name="class_standard" class="form-control" id="class_standard"
                                                    style="height: 52px;" required>
                                                    <option value="" selected="selected">--Select--</option>
                                                    <option
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3 form-group">
                                                ...
                                                <input type="email" name="address" id="address"
                                                    ...
                                                    value="{{ $student->user_details->address ?? '' }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3 form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3 form-group">
                                                ...
                                                <select name="father_occupation" class="form-control"
                                                    id="father_occupation" style="height: 52px;" readonly>
