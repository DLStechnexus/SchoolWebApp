...
<head>
    ...
    <link href="{{ asset('backend/plugin/datatable/css/dataTables.bootstrap5.min.css') }}" rel="stylesheet" />
</head>
...
<body class="crm_body_bg">
    ...
    <script src="{{ asset('backend/plugin/datatable/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('backend/plugin/datatable/js/dataTables.bootstrap5.min.js') }}"></script>
